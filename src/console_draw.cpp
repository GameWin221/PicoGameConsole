...
void console_draw_rectangle(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color)
{
...
void console_draw_char(uint16_t x, uint16_t y, uint16_t color, char character, const Font& font)
{
...
void console_draw_string(uint16_t x, uint16_t y, uint16_t color, const char* str, const Font& font) 
{
    console_draw_string_rect(x, y, LCD_WIDTH, LCD_HEIGHT, color, str, font);
}
void console_draw_string_rect(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, const char* str, const struct Font& font)
{
